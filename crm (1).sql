...
--
-- Host: localhost
-- Generation Time: Mar 13, 2021 at 05:33 AM
...
('m5v9rcd1hep2tsnld6d18koj52jtaqej', '27.57.166.33', 1614748463, 0x5f5f63695f6c6173745f726567656e65726174657c693a313631343734383134383b61646d696e5f64657461696c737c613a323a7b733a373a22757365725f6964223b733a313a2231223b733a31313a2261646d696e5f6c6f67696e223b733a31313a2261646d696e5f6c6f67696e223b7d),
('j8si67he0h4a977t1r9d7ns12fsnd9ut', '27.57.166.33', 1614834088, 0x5f5f63695f6c6173745f726567656e65726174657c693a313631343833343038383b),
('3m84df7canf5b5pcqqh2r44ahccd9avt', '27.57.166.33', 1614835013, 0x5f5f63695f6c6173745f726567656e65726174657c693a313631343833353031333b61646d696e5f64657461696c737c613a323a7b733a373a22757365725f6964223b733a313a2231223b733a31313a2261646d696e5f6c6f67696e223b733a31313a2261646d696e5f6c6f67696e223b7d),
('ok4m7cjmbm0hu8aga8a5b6sunc499q0b', '157.32.126.168', 1614885102, 0x5f5f63695f6c6173745f726567656e65726174657c693a313631343838353039373b),
('uh01se1q42a52c56o6n5ljnlg6m2cmao', '27.57.166.33', 1615263932, 0x5f5f63695f6c6173745f726567656e65726174657c693a313631353236333932353b61646d696e5f64657461696c737c613a323a7b733a373a22757365725f6964223b733a313a2231223b733a31313a2261646d696e5f6c6f67696e223b733a31313a2261646d696e5f6c6f67696e223b7d),
('ghdst4r30omb728oqua5nhmqvmrm47hk', '27.57.166.33', 1615273225, 0x5f5f63695f6c6173745f726567656e65726174657c693a313631353237333232353b);
...
CREATE TABLE `tbl_address` (
  ...
  `contacts_addresses` tinyint(1) NOT NULL DEFAULT 1 COMMENT '1=main,2=contact,3=invoice address,4=delivery address,5=other address,6=private address',
  ...
  `s﻿t﻿a﻿t﻿e` varchar(50) NOT NULL,
  `zip` varchar(12) NOT NULL,
  `c﻿o﻿u﻿n﻿t﻿r﻿y` varchar(50) NOT NULL,
  `gst_treatment` varchar(255) NOT NULL,
  `vat` varchar(255) NOT NULL,
  `website_link` text NOT NULL,
  `eDelete` tinyint(1) NOT NULL DEFAULT 0,
...
CREATE TABLE `tbl_contacts` (
  ...
  `tags` text NOT NULL,
  `contacts_addresses` text NOT NULL,
  ...
  `internal_notes_2` longtext NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tbl_country` (`id`, `sortname`, `name`, `phonecode`) VALUES
(1, 'AF', 'Afghanistan', 93),
(2, 'AL', 'Albania', 355),
(3, 'DZ', 'Algeria', 213),
...
CREATE TABLE `tbl_invoice` (
  ...
  `invoice_combo_id` varchar(20) NOT NULL,
...
INSERT INTO `tbl_language` (`id`, `value`) VALUES
('aa', 'Afar'),
('ab', 'Abkhazian'),
('ace', 'Achinese'),
('ach', 'Acoli'),
...
CREATE TABLE `tbl_leads` (
  ...
  `lead_generation_name` varchar(255) NOT NULL,
  `order_number_leads` text NOT NULL,
  `combo_id` varchar(100) NOT NULL,
  `joined_us_on` datetime NOT NULL,
  `follow_up_date` datetime NOT NULL,
  `contact_person_name` varchar(255) NOT NULL,
  `contact_person_email` varchar(255) NOT NULL,
  `contact_person_skype_id` varchar(255) NOT NULL,
...
INSERT INTO `tbl_leads` (`lead_id`, `user_id`, `lead_generation_name`, `order_number_leads`, `combo_id`, `joined_us_on`, `follow_up_date`, `contact_person_name`, `contact_person_email`, `contact_person_skype_id`, `company_email`, `phone_number`, `mobile_number`, `company_website`, `company_name`, `address`, `zip_code`, `fax`, `state_name`, `city`, `country`, `facebook_url`, `twitter_url`, `skype_url`, `client_type`, `lead_status`, `lead_source`, `eDelete`, `created_date`, `updated_date`) VALUES
(1, 0, 'manish', 'leads-0001', '', '2021-03-02 00:00:00', '2021-03-05 00:00:00', 'abcd', 'abcd@gmail.com', 'abcdskype', 'abcdcom@gmail.com', '7417417410', '7417417410', 'abcdgoogle.com', 'abcd_cname', 'abcd_a12ahme', 'abcd_369', 'abcd_123', 'abcd_guj', 'abcd_in', 'abcd_ahme', 'abcd_face', 'abcd_twitter', 'abcd_sky', 'Biding', 'OPEN - NotContacted', 'Phone Enquiry', 0, '2021-03-03 10:43:56', '0000-00-00 00:00:00'),
(2, 0, 'smita', 'leads-0002', '', '2021-03-02 00:00:00', '2021-03-05 00:00:00', 'xyz', 'xyz@gmail.com', 'xyzskype', 'xyzcom@gmail.com', '7410741456', '7410741456', 'xyzgmmmgm.com', 'xyz_cname', 'xyz_a12ahme', 'xyz_369', 'xyz_126', 'xyz_guj', 'xyz_ti', 'xyz_ame', 'xyz_face', 'xyz_twitter', 'xyz_kyp', 'Reference', 'OPEN - AttemptedContact', 'Partner Referral', 0, '2021-03-03 10:43:56', '0000-00-00 00:00:00'),
(3, 0, 'ankit', 'leads-0003', '', '2021-03-02 00:00:00', '2021-03-05 00:00:00', 'asdf', 'asdf@gmail.com', 'asdfskype', 'asdfcom@gmail.com', '8528521230', '8528521230', 'asdfgoogle.com', 'asdf_cname', 'asdf_a12ahme', 'asdf_369', 'asdf_129', 'asdf_guj', 'asdf_ik', 'asdf_ahme', 'asdf_face', 'asdf_twitter', 'asdf_sky', 'Reference', 'OPEN - Contacted', 'Web', 0, '2021-03-03 10:43:56', '0000-00-00 00:00:00'),
(4, 0, 'deversh', 'leads-0004', '', '2021-03-02 00:00:00', '2021-03-05 00:00:00', 'hjkl', 'hjkl@gmail.com', 'hjklskype', 'hjklcom@gmail.com', '9529529520', '9529529520', 'hjklgoogle.com', 'hjkl_cname', 'hjkl_a12ahme', 'hjkl_369', 'hjkl_121', 'hjkl_guj', 'hjkl_ev', 'hjkl_ahme', 'hjkl_face', 'hjkl_twitter', 'hjkl_sky', 'B2B', 'CLOSED - Disqualified', 'Phone Enquiry', 0, '2021-03-03 10:43:56', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_leads2`
--

CREATE TABLE `tbl_leads2` (
  `lead_id` int(11) NOT NULL,
  `order_number_leads` text NOT NULL,
  `combo_id` varchar(100) NOT NULL,
  `title` varchar(255) NOT NULL,
  `lead_source_id` int(11) NOT NULL,
  `lead_industry_id` int(11) NOT NULL,
...
CREATE TABLE `tbl_products` (
  `product_id` int(11) NOT NULL,
  `sales_combo_id` varchar(50) NOT NULL,
  `product_name` varchar(500) NOT NULL,
  `product_description` text NOT NULL,
  `product_qty` varchar(255) NOT NULL,
  `unit_price` varchar(255) NOT NULL,
  `product_taxs` varchar(255) NOT NULL,
  `subtotal` varchar(255) NOT NULL,
  `section_sales` text NOT NULL,
  `noted_sales` text NOT NULL,
  `product_type` tinyint(1) NOT NULL DEFAULT 0 COMMENT '0=product,1=optional products',
  `eDelete` tinyint(1) NOT NULL DEFAULT 0,
...
CREATE TABLE `tbl_sales` (
  ...
  `sales_combo_id` varchar(50) NOT NULL,
  `sales_customer` varchar(255) NOT NULL,
  `gst_treatment` varchar(255) NOT NULL,
  ...
  `online_signature` varchar(255) NOT NULL,
  `online_payment` varchar(255) NOT NULL,
  `customer_reference` varchar(255) NOT NULL,
  `fiscal_position` varchar(255) NOT NULL,
  `journal` varchar(255) NOT NULL,
  `shipping_policy` varchar(500) NOT NULL,
...
CREATE TABLE `tbl_users` (
  ...
  `slug_username` varchar(255) NOT NULL,
  `first_name` varchar(500) NOT NULL,
  `last_name` varchar(255) NOT NULL,
  `email` varchar(255) NOT NULL,
  `code` varchar(10) NOT NULL,
  `mobile_no` varchar(255) NOT NULL,
  `password` varchar(255) NOT NULL COMMENT '1[^&*]({ANJpms})[@#$%]',
...
INSERT INTO `tbl_users` (`user_id`, `username`, `slug_username`, `first_name`, `last_name`, `email`, `code`, `mobile_no`, `password`, `last_login`, `first_login`, `last_ip`, `created_at`, `updated_at`, `eDelete`) VALUES
(1, 'crm', 'crm', 'crm', 'crm', 'crm@gmail.com', '', '', '$2y$10$WhHUCUtZoVYvSkxXzuuuAuF2wd9Mh2wmZPowEAzJBfKNDtz5E9UkK', '2021-02-13 15:43:52', '2021-01-22 13:29:24', '', '2021-01-22 08:57:28', '2021-01-22 09:57:28', 0),
(2, 'smita', 'smita', 'smita', 'smita', 'smita@gmail.com', '', '', '$2y$10$WhHUCUtZoVYvSkxXzuuuAuF2wd9Mh2wmZPowEAzJBfKNDtz5E9UkK', '2021-02-13 15:43:52', '2021-01-22 13:29:24', '', '2021-01-22 08:57:28', '2021-01-22 09:57:28', 0),
(3, 'ankit', 'ankit', 'ankit', 'ankit', 'ankit@gmail.com', '', '', '$2y$10$WhHUCUtZoVYvSkxXzuuuAuF2wd9Mh2wmZPowEAzJBfKNDtz5E9UkK', '2021-02-13 15:43:52', '2021-01-22 13:29:24', '', '2021-01-22 08:57:28', '2021-01-22 09:57:28', 0),
(4, 'devarsh', 'devarsh', 'devarsh', 'devarsh', 'devarsh@gmail.com', '', '', '$2y$10$WhHUCUtZoVYvSkxXzuuuAuF2wd9Mh2wmZPowEAzJBfKNDtz5E9UkK', '2021-02-13 15:43:52', '2021-01-22 13:29:24', '', '2021-01-22 08:57:28', '2021-01-22 09:57:28', 0);
...
--
-- Indexes for table `tbl_leads2`
--
ALTER TABLE `tbl_leads2`
  ADD PRIMARY KEY (`lead_id`);
...
--
-- AUTO_INCREMENT for table `tbl_leads2`
--
ALTER TABLE `tbl_leads2`
