					...
					<tr>
						<td bgcolor='#ffffff' style='padding: 40px 30px 40px 30px;'>
							<table border='0' cellpadding='0' cellspacing='0' width='100%'>
								<tr>
									<td style='color: #153643; font-family: Arial, sans-serif; font-size: 24px;'>
										<b>Hello Apurva Prajapati,</b>
									</td>
								</tr>
								<tr>
									<td style='padding: 20px 0 10px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;'>
										You recently changed your email address in your Trello account. To confirm the change, please check <a href='#' style='font-weight: bold;color: #1473E6;text-decoration: none;'>apurva@anjwebtech.com</a> to verify and complete the update.
									</td>
								</tr>
								<tr>
									<td style='padding: 10px 0 10px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;'>
