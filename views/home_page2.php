            ...
            <div class="row">
              <div class="col-lg-4 col-md-6">
                <div class="iq-feature-box">
                  ...
                  <a href="JavaScript:void()" class="text-blue readmore">Read More</a>
                </div>
              </div>
              <div class="col-lg-4 col-md-6">
                <div class="iq-feature-box">
              ...
              <div class="col-lg-4 col-md-6">
                <div class="iq-feature-box">
                  <i class="flaticon-ip flaticon mb-3"></i>
                   <h4 class="mb-3">IP Addrtess control</h4>
                  <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.</p>
                  <a href="JavaScript:void()" class="text-blue readmore">Read More</a>
                </div>
              </div>
      ...
      <script type="text/javascript">
        ...
        function platinum_packege(price_hide){
          $.ajax({
            ...
            success: function(response){
              window.location.href = 'http://anjpms.com/register/';
            }
          });
        } 
        ...
        function upgradePlanM(price_hide){
          $.ajax({
            ...
            data: {price_hide:price_hide},
            success: function(response){
              window.location.href = 'http://anjpms.com/upgradePlanM/';
            }
          });
        }
