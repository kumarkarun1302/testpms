<?php
	...
	try {
		...
		$client = new WC_API_Client( 'http://localhost:88/phpprojects/careandcure', 'ck_b7bca180929dc5116479de6428643abd95065686', 'cs_d39904dc56115ebf29fb20f5e9529b96c412b5ca', $options );
		$request='';
