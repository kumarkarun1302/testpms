...
class Paypala extends CI_Controller {
	...
	public function index(){
		...
		echo '<a href="'.base_url().'paypala/buyProduct/1"><img src="'.base_url('assets/images/header_logo.png').'" style="width: 70px;"></a>';
	}
		
	function buyProduct(){
		//Set variables for paypal form
		$returnURL = base_url().'paypala/success'; //payment success url
		$cancelURL = base_url().'paypala/cancel'; //payment cancel url
		$notifyURL = base_url().'paypala/ipn'; //ipn url
		...
		$this->paypal_lib->add_field('amount',  0.10);        
