          ...
          ?>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single-blog">
                   <div class="image">
                      <a href="<?php echo base_url('blog_details/'); ?><?php echo $value['blog_id']; ?>">
                      <img src="<?php echo base_url('uploads/'); ?><?php echo $value['blog_image']; ?>" class="img-fluid" alt="image">
                      </a>
                      <div class="btn">
                         <a href="<?php echo base_url('blog_details/'); ?><?php echo $value['blog_id']; ?>"><?php echo $value['categories']; ?></a>
                      </div>
                   </div>
                   <div class="content">
                      <ul class="post-meta">
                      ...
                      <a href="<?php echo base_url('blog_details/'); ?><?php echo $value['blog_id']; ?>" class="read-more">
                      Read More
                      </a>
                   </div>
                </div>
