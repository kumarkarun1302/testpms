                            ...
                            <div class="col-sm-8 col-4">
                                <ul class="list-inline user-chat-nav text-right mb-0">
                                   ...
                                   <!--  <li class="list-inline-item d-none d-lg-inline-block">
                                    ...
                                    <li class="list-inline-item d-none d-lg-inline-block" onclick="current_profile_about()" id="userprofileshow" style="display: none !important;">
