...
<div class="form-group mb-4">
    ...
    <!-- <div class="mb-3">
        <button class="btn btn-light btn-sm" type="button" data-toggle="collapse" data-target="#groupmembercollapse" aria-expanded="false" aria-controls="groupmembercollapse" onclick="hideshowselect_members()">Select Members</button>
    </div> -->
