...
if(!empty($order)){ ?>
                            ...
                            <?php } ?>
                              ...
                              <p>Reference Number: <span class="orderValue"><?php echo $order['id']; ?></span></p>
                              <p>Transaction ID: <span class="paymentValue"><?php echo $order['txn_id']; ?></span></p>
                              <p>Paid Amount: <span class="packageNameValue"><?php echo $order['paid_amount'].' '.$order['paid_amount_currency']; ?></span></p>
                              <p>Payment Status: <span class="packageNameValue"><?php echo $order['payment_status']; ?></span></p>
