  ...
  if($(event.relatedTarget).data('project')=='edit'){
    ...
    $.ajax({
      ...
      success: function(response) {
        ...
        $("#project_priority").val(response.project_priority);
        $("#billing_type_id").val(response.billing_type_id);
        $("#estimated_hours").val(response.estimated_hours);
        $("#project_phase").val(response.project_phase);
        $("#project_demo_url").val(response.project_demo_url);
