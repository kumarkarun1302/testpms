...
$("#submitButton").click(function () {
  ...
  if($("#edit_task_id").val()){
    ...
    var edit_task_id = $("#edit_task_idview").val();
  }
  ...
  $.ajax({
    ...
    success: function(response) {
      ...
      if(response.task_file){
        var abcd = main_url+'uploads/'+response.task_file;
        var htmlfile = '<a href="'+abcd+'" download="'+response.task_file+'"><img src="'+abcd+'" id="onChangeImg" class="img-fluid"></a>';
      } else {
var htmlfile = '<a href="not_delete_image_by_defult_user_image.png" download="not_delete_image_by_defult_user_image.png"><img src="'+main_url+'uploads/not_delete_image_by_defult_user_image.png" id="onChangeImg" class="img-fluid"></a>';
      }
